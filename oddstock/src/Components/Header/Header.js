            ...
            <Navbar collapseOnSelect expand="lg" bg="light" className="top-fixed">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="justify-content-md-end text-center me-auto w-100">
                        ...
                        {
                            porps.login?
                            <Nav.Link href="#pricing" style={{backgroundColor:"#E1EFFF",borderRadius: "0.5rem",fontWeight: "500"}} className="px-lg-4"><LockOpenIcon/> {porps.accountHolder}</Nav.Link>:
                            <Nav.Link href="#account" className="px-lg-4"><LockIcon/> Account</Nav.Link>
                        }
                    </Nav>
                </Navbar.Collapse>
                </Container>
